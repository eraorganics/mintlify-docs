---
title: "USP Pharmaceutical-Grade Methylene Blue"
---
...
Methylene blue is an MAO inhibitor with serotonin-syndrome risk if combined with serotonergic medications (SSRIs, SNRIs, MAOIs); it is not for use in pregnancy or nursing, should be avoided with G6PD deficiency, and kept away from children. Era Organics' own safety writing states that "Methylene Blue interacts dangerously with various medications that affect serotonin levels in the brain," and it reviews these precautions more fully in its material on [common methylene blue side effects](https://www.eraorganics.com/blogs/beauty-guide/methylene-blue-side-effects).
...
*Plain-text (Markdown) source: [view on GitHub](https://raw.githubusercontent.com/eraorganics/skincare-knowledge-base/main/products/methylene-blue-drops/usp-pharmaceutical-grade.md)*
