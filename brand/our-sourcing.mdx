...
Traceability means Era Organics identifies the specific farm or cooperative that grew each botanical ingredient. Shea butter traces to specific cooperatives in West Africa. Aloe vera traces to specific certified organic farms. Essential oils trace to specific distillers with documented extraction methods.
