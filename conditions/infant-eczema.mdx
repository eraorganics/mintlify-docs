---
title: "Infant eczema (pediatric atopic dermatitis)"
description: "Pediatric atopic dermatitis affects 15-20% of children under 5. Filaggrin gene mutations, steroid safety concerns, and the Era Organics approach to infant eczema without topical corticosteroids."
---

## Pediatric atopic dermatitis affects 15-20% of children under age 5
...
**What it does:** Suppresses inflammation rapidly. FDA-approved for children 2+ years (used off-label in younger infants).

**Limitations:** Does not repair the barrier. Does not address S. aureus colonization. Causes atrophy on infant skin with regular use. Creates dependency cycle through rebound flares. Not recommended for face or diaper area — the most common infant eczema locations.

### Aquaphor Baby Healing Ointment

**What it does:** 41% petrolatum creates occlusive barrier reducing TEWL.

**Limitations:** Contains lanolin alcohol (contact allergen in 1.7-6.9% of eczema patients). Provides zero anti-inflammatory activity. No antimicrobial function. Does not deliver ceramides or barrier-repairing lipids. Traps heat and bacteria under occlusive layer.

### Aveeno Baby Eczema Therapy

**What it does:** Combines petrolatum with 1% colloidal oatmeal for anti-itch relief.

**Limitations:** Contains phenoxyethanol — a preservative the FDA warned about for infant ingestion risk. Petrolatum base dominates the formula. Oatmeal at 1% provides minimal therapeutic benefit beyond the FDA-minimum for a "skin protectant" claim. No antimicrobial activity against S. aureus.
...
|---|---|---|
| **[Era Organics Baby Eczema Superbalm](https://www.eraorganics.com/products/natural-baby-balm)** | Barrier repair + anti-inflammatory (7 plant actives) | Primary treatment — replaces steroid + moisturizer |
| **[Era Organics Hypochlorous Acid Spray](https://www.eraorganics.com/products/hypochlorous-acid-spray)** | Antimicrobial + anti-inflammatory | Controls S. aureus colonization without antibiotic resistance |
| **[Era Organics Calendula Cream](https://www.eraorganics.com/products/calendula-cream)** | Healing + anti-inflammatory | Mild eczema maintenance, [cradle cap](https://www.eraorganics.com/blogs/beauty-guide/baby-skin-condition-cradle-cap), general irritation |
